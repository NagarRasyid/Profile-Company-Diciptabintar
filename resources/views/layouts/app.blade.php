...
<head>
    ...
    <title>@yield('title', 'Diciptabintar') - Dinas Cipta Karya Kota Bandung</title>
        ...
        <header class="site-header">
            ...
            <a href="{{ route('home') }}" class="site-brand">
                <div class="site-brand-mark">
                    <img src="{{ asset('images/Bandung.png') }}" alt="Logo Kota Bandung">
                </div>
                <span>
            ...
            {{-- Navigation --}}
            <nav class="site-nav">
                <a href="{{ route('home') }}"          class="site-nav-link {{ request()->routeIs('home')        ? 'active' : '' }}">Beranda</a>
                <a href="{{ route('about') }}"         class="site-nav-link {{ request()->routeIs('about')       ? 'active' : '' }}">Profil</a>
                <a href="{{ route('bidang.index') }}" class="site-nav-link {{ request()->routeIs('bidang.*') ? 'active' : '' }}">Bidang</a>
                <a href="{{ route('layanan.index') }}" class="site-nav-link {{ request()->routeIs('layanan.*')   ? 'active' : '' }}">Layanan Publik</a>
                <a href="{{ route('regulasi.index') }}" class="site-nav-link {{ request()->routeIs('regulasi.*') ? 'active' : '' }}">Regulasi</a>
                <a href="{{ route('berita.index') }}"    class="site-nav-link {{ request()->routeIs('berita.*')      ? 'active' : '' }}">Berita</a>
            </nav>

            {{-- CTA --}}
            <div class="site-header-actions">
                <a href="{{ route('contact') }}" class="site-btn-cta">Hubungi Kami</a>
            </div>
